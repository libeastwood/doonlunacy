...
/*	void assignAirUnit(Uint32 newObjectID);
	...
	*/
	 ...
	 */
	void damageCell(ObjectPtr damager, WeaponClass *weapon, UPoint realPos, std::string weaponName, int bulletDamage, int damagePiercing, int damageRadius, bool air);
