...

{
	...
	fileNames[Picture_DeathHand] = "data/graphics/Picture_DeathHand.png";//altered

	fileNames[Picture_Fremen] = "data/graphics/Picture_Fremen.png";//altered
	...
	fileNames[Picture_Saboteur] = "data/graphics/Picture_Saboteur.png";//altered
	...
	fileNames[SoundVO_AConst] = "data/sound/atre/aconst.ogg";

	fileNames[SoundVO_ALose] = "data/sound/atre/alose.ogg";

	fileNames[SoundVO_AWin] = "data/sound/atre/awin.ogg";
	...
	fileNames[SoundVO_HConst] = "data/sound/hark/hconst.ogg";

	fileNames[SoundVO_HLose] = "data/sound/hark/hlose.ogg";

	fileNames[SoundVO_HWin] = "data/sound/hark/hwin.ogg";
	...
	fileNames[SoundVO_OConst] = "data/sound/ordos/oconst.ogg";

	fileNames[SoundVO_OLose] = "data/sound/ordos/olose.ogg";

	fileNames[SoundVO_OWin] = "data/sound/ordos/owin.ogg";
	...
	fileNames[Structure_ConstructionYardPlace] = "data/graphics/Structure_BuildingConyard.png";
	...
	fileNames[Structure_Refinery] = "data/graphics/Structure_Refinery.png";//altered
	...
	fileNames[Structure_StarPort] = "data/graphics/Structure_StarPort.png";
...

	{
...

		{
			...
			SDL_Surface *prescaled = IMG_Load_RW(SDL_RWFromFile(fileNames[count], "rb"), 0);
                        SDL_Surface *scaled = prescaled; //zoomSurface(prescaled, 2.0, 2.0, SMOOTHING_OFF);
                        //printf("  image size %u %u\n", prescaled->w, prescaled->h);
                        //printf("  image bpp %u\n", prescaled->format->BitsPerPixel);
                        dataFile[count].dat = (char*)scaled;
                        //printf("  image scaled size %u %u\n", scaled->w, scaled->h);
                        //printf("  image scale bpp %u\n", scaled->format->BitsPerPixel);
                        //SDL_FreeSurface(prescaled);
...
{
    int x;
    for (x=Structure_Building22; x<= Terrain_ThickSpice; x++)
    {
      scaleData(x, 2.0);
    };

    for (x=Unit_Carryall; x <= Unit_Trooper; x++)
    {
      scaleData(x, 2.0);
    };
};
