...
BuildItemClass::BuildItemClass(int newItemID)
{
	...
	case (Structure_Barracks):
		...
		sprintf(description, "%s: %.2f", name, round(cost));
		break;
	case (Structure_ConstructionYard):
		...
		sprintf(description, "Construction Yard: %.2f", round(cost));
		break;
	case (Structure_GunTurret):
		...
		sprintf(description, "Gun Turret: %.2f", round(cost));
		break;
	case (Structure_HeavyFactory):
		...
		sprintf(description, "Heavy Factory: %.2f", round(cost));
		break;
	...
	case (Structure_IX):
		...
		sprintf(description, "House of IX: %.2f", round(cost));
		break;
	case (Structure_LightFactory):
		...
		sprintf(description, "Light Factory: %.2f", round(cost));
		break;
	case (Structure_Palace):
		...
		sprintf(description, "Palace: %.2f", round(cost));
		break;
	case (Structure_Radar):
		...
		structureSize.y = 2;
		sprintf(name, "Radar");
		sprintf(description, "Radar: %.2f", round(cost));
		break;
	case (Structure_Refinery):
		...
		sprintf(description, "Refinery: %.2f", round(cost));
		break;
	case (Structure_RepairYard):
		...
		sprintf(description, "Repair Yard: %.2f", round(cost));
		break;
	case (Structure_RocketTurret):
		...
		sprintf(description, "Rocket Turret: %.2f", round(cost));
		break;
	case (Structure_Silo):
		bListPriority = 5;
		cost = 150;
		...
		structureSize.y = 2;
		sprintf(name, "Silo");
		sprintf(description, "Silo: %.2f", round(cost));
		break;
	case (Structure_StarPort):
		...
		sprintf(description, "Star Port: %.2f", round(cost));
		break;
	case (Structure_Slab1):
		...
		sprintf(description, "1x1 Concrete Slab: %.2f", round(cost));
		break;
	case (Structure_Slab4):
		...
		sprintf(description, "2x2 Concrete Slab: %.2f", round(cost));
		break;
	case (Structure_Wall):
		bListPriority = 2;
		cost = 50;
		...
		structureSize.y = 1;
		sprintf(name, "Wall");
		sprintf(description, "Wall: %.2f", round(cost));
		break;	
	case (Structure_WindTrap):
		...
		sprintf(description, "Wind Trap: %.2f", round(cost));
		break;	
	case (Structure_WOR):
		bListPriority = 10;
		cost = 400;
		...
		structureSize.y = 2;
		sprintf(name, "WOR");
		sprintf(description, "WOR: %.2f", round(cost));
		break;
	...
	case (Unit_Carryall):
		...
		sprintf(description, "Carryall: %.2f", round(cost));
	...
	case (Unit_Devastator):
		...
		sprintf(description, "Devastator: %.2f", round(cost));
		break;
	case (Unit_Deviator):
		bListPriority = 3;
		cost = 750;
		...
		sprintf(description, "Deviator: %.2f", round(cost));
		break;
	case (Unit_Harvester):
		bListPriority = 11;
		cost = 300;
		...
		sprintf(description, "Harvester: %.2f", round(cost));
		break;
	case (Unit_Infantry):
		bListPriority = 10;
		cost = 100;
		...
		sprintf(description, "Light Infantry: %.2f", round(cost));
		break;
	case (Unit_Launcher):
		bListPriority = 5;
		cost = 600;
		...
		sprintf(description, "Rocket Launcher: %.2f", round(cost));
		break;		
	case (Unit_MCV):
		bListPriority = 12;
		cost = 900;
		picID = Picture_MCV;
		sprintf(name, "MCV");
		sprintf(description, "MCV: %.2f", round(cost));
		break;
	...
	case (Unit_Ornithopter):
		...
		sprintf(description, "Ornithopter: %.2f", round(cost));
	...
	case (Unit_Quad):
		...
		picID = Picture_Quad;
		sprintf(name, "Quad");
		sprintf(description, "Quad: %.2f", round(cost));
		break;
	case (Unit_SiegeTank):
		bListPriority = 4;
		cost = 600;
		...
		sprintf(description, "Siege Tank: %.2f", round(cost));
		break;
	case (Unit_SonicTank):
		bListPriority = 2;
		cost = 800;
		...
		sprintf(description, "Sonic Tank: %.2f", round(cost));
		break;
	case (Unit_Tank):
		bListPriority = 7;
		cost = 300;
		...
		sprintf(description, "Combat Tank: %.2f", round(cost));
		break;
	case (Unit_Trike):
		bListPriority = 9;
		cost = 150;
		picID = Picture_Trike;
		sprintf(name, "Trike");
		sprintf(description, "Trike: %.2f", round(cost));
		break;
	case (Unit_Raider):
		bListPriority = 9;
		cost = 150;
...
//		picID = Picture_Trike;
		...
		sprintf(description, "Ordos Raider: %.2f", round(cost));
		break;
	case (Unit_Trooper):
		bListPriority = 12;
		cost = 50;
		...
		sprintf(description, "Rocket Trooper: %.2f", round(cost));
		break;
	case (Unit_Fremen):
		bListPriority = 12;
		cost = 75;
		...
		sprintf(description, "Fremen Trooper: %.2f", round(cost));
		break;
	case (Unit_Sardaukar):
		bListPriority = 12;
		cost = 75;
		...
		sprintf(description, "Sardaukar Trooper: %.2f", round(cost));
		break;
	default:
		bListPriority = 1000;
		cost = 300;
